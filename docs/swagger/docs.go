            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/follow.FollowResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/follow.ErrorResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/api/follow/{user_id}": {
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "User ID (UUID) to unfollow",
                        "name": "user_id",
                        "in": "path",
                        "required": true
                    }
